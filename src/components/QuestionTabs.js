...
class QuestionTabs extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.all([
            axios.get('http://localhost:8080/api/home/getTopics'),
            axios.get('http://localhost:8080/api/home/getTopicsAns'),
            axios.get('http://localhost:8080/api/home/getTopicsNoAns')
        ])
