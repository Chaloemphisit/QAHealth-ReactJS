...
import { Card, CardBody, CardHeader, FormGroup, Input, Label, Col, Row, Button, FormText } from 'reactstrap';
                        ...
                        <CardBody>
                            <Row>
                                <Col md={4} sm={12} xs={12} align="center">
                                    ...
                                    <h4 className="mt-3"><Button outline color="info">แก้ไขโปรไฟล์</Button>{' '}</h4>
                                </Col>
